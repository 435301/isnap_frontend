...
const TaskSummary = () => {
  ...
  // ✅ Normal task discussions
  const discussions = [
    { id: 1, iconBg: '#3B82F6', title: 'You sent 1 Message to the contact.', time: '10 Jan 2024, 10:00 am' },
    { id: 2, iconBg: '#F59E0B', title: 'iSnap responded to your appointment schedule question.', time: '10 Jan 2024, 10:00 am' },
    { id: 3, iconBg: '#3B82F6', title: `Please accept my apologies for the inconvenience caused.`, time: '25 Jul 2025, 05:00 pm' },
    { id: 4, iconBg: '#F59E0B', title: `Please accept my apologies for the inconvenience caused.`, time: '25 Jul 2025, 05:00 pm' },
    { id: 5, iconBg: '#3B82F6', title: `Please accept my apologies for the inconvenience caused.`, time: '25 Jul 2025, 05:00 pm' },
  ...
  // ✅ Rejected tasks data
  const rejectedTasks = [
    { id: 101, iconBg: '#3B82F6', title: 'Task rejected due to incomplete documentation.', time: '12 Aug 2025, 03:30 pm' },
    { id: 102, iconBg: '#F59E0B', title: 'Task rejected because it missed the deadline.', time: '08 Aug 2025, 01:15 pm' },
    { id: 103, iconBg: '#3B82F6', title: 'Task rejected due to quality issues.', time: '01 Aug 2025, 10:00 am' },
    { id: 104, iconBg: '#F59E0B', title: 'Task rejected due to quality issues.', time: '01 Aug 2025, 10:00 am' },
    { id: 105, iconBg: '#3B82F6', title: 'Task rejected due to quality issues.', time: '01 Aug 2025, 10:00 am' },
        ...
        <div className="container-fluid px-3 pt-4">
          ...
          <div className="bg-white p-2 px-3 rounded shadow-sm mb-4 border">
            ...
            <div className="d-flex justify-content-between align-items-center pb-2 mb-3 mt-3">
              ...
              <div>
                <select className="form-select form-select-sm" style={{ width: 120 }} defaultValue="In Progress">
                  <option>To Do</option>
          ...
          <div className="bg-white p-3 rounded shadow-sm card-header mb-3">
            <div className="row">
              ...
              {/* Right - Rejected Tasks */}
              <div className="col-lg-6">
                <h5 className="mb-4 fw-semibold text-danger">Task Rejected ({rejectedTasks.length})</h5>
                {rejectedTasks.map(renderDiscussion)}
              </div>
            </div>
          </div>
