...
import { fetchTeamSupport } from "../../redux/actions/adminSupportAction";
...
const ManageTeamSupport = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { windowWidth, isSidebarOpen, setIsSidebarOpen } = useResponsiveSidebar(992);
  const { teamSupports, loading, pagination } = useSelector((state) => state.adminSupport);
  ...
  useEffect(() => {
    dispatch(fetchTeamSupport({ page: currentPage, search: searchTerm, issueTypeId: issueTypeId, supportStatusId: supportStatusId, sellerId: sellerId }));
    dispatch(fetchIssueType({ page: "", search: "", showStatus: "" }));
    dispatch(fetchSupportStatus({ page: "", search: "", showStatus: "" }));
    dispatch(fetchBusinessDetails());
  }, [dispatch, currentPage, searchTerm, issueTypeId, supportStatusId, sellerId]);
  ...
  const handleDelete = async () => {
    ...
    dispatch(fetchTeamSupport({ page: currentPage, search: searchTerm, issueTypeId: issueTypeId, supportStatusId: supportStatusId })
    );
    setDeleteId(null);
            ...
            <div className="bg-white p-3 rounded shadow-sm ">
              <div className="row align-items-center">
                ...
                <div className="col-md-6 text-md-end mt-2 mt-md-0">
                  <Link to="/team/add-support" className="btn btn-new-lead">
...
export default ManageTeamSupport;
