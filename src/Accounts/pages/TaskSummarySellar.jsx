...
const TaskSummary = () => {
  ...
  const discussions = [
    ...
    },
    {
      ...
      iconBg: "#F59E0B",
      title:
        "iSnap responded to your appointment schedule question by call at 09:30pm.",
      time: "10 Jan 2024, 10:00 am",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      iconBg: "#3B82F6",
      title:
        "You responded to your appointment schedule question by call at 09:30pm.",
      time: "10 Jan 2024, 10:00 am",
    },
  ];
        ...
        <div className="container-fluid px-4 pt-4">
          ...
          <div className="bg-white p-2 px-3 rounded shadow-sm mb-4 border">
            <div className="border-bottom">
              <h5 className="section-heading">Task Summary</h5>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center pb-2 mb-3 mt-3">
              <div className="d-flex align-items-center gap-2">
                ...
                <h5 className="mb-0 fw-semibold">
                  Update iSNAP new project design
                </h5>
              </div>
            ...
            <div className="border p-3">
              ...
              <div className="mb-3 key-task">
                ...
                <ol className="small ps-3">
                  ...
                  <li>
                    Iteratively refining the design based on feedback.
                  </li>
                  <li>
              ...
              <div className="border-top pt-3 mt-3 d-flex justify-content-start sellar small gap-4 flex-wrap">
                <div>
                  <strong className="text-dark">Seller Name:</strong> GVK
                  Fashions
                </div>
                <div>
                  <strong className="text-dark">Start Date:</strong> June 10,
                  2025
                </div>
                <div>
                  <strong className="text-dark">Due Date:</strong> June 20, 2025
                </div>
                <div>
