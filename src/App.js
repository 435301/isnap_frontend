...
const ViewSeller = lazy(() => import("./admin/pages/ViewSeller"));
...
function App() {
  return (
    <Router><Suspense fallback={<div className="text-center mt-5">Loading...</div>}>
      <Routes>
        {/* Public Routes */}
        ...
        {/* Admin Routes */}
        <Route
          path="/dashboard" element={<AdminRoute>  <AdminDashboard /> </AdminRoute>} />
        <Route
          path="/add-market-type" element={<AdminRoute>   <AddMarketplaceType /> </AdminRoute>} />
        <Route
          path="/view-lead/:id" element={<AdminRoute>    <ViewLead /></AdminRoute>} />
        <Route
          path="/view-seller/:id" element={<AdminRoute>  <ViewSeller /> </AdminRoute>}
        />
        <Route
          path="/edit-seller/:id"
          element={<AdminRoute>     <EditSeller />  </AdminRoute>} />
        <Route
          path="/latest-updates" element={<AdminRoute>    <LastestUpdates />  </AdminRoute>} />
        <Route
          path="/reports" element={<AdminRoute> <ManageReports />     </AdminRoute>} />
        <Route path="/edit-latest-updates/:id" element={<AdminRoute>      <EditTeamLatestUpdates />   </AdminRoute>} />
        <Route
          path="/manage-roles-features" element={<AdminRoute>   <RoleAccess /> </AdminRoute>} />
        ...
        <Route path="/support" element={<AdminRoute>    <ManageSupport /></AdminRoute>} />
        <Route path="/add-support" element={<AdminRoute>   <AddSupport />    </AdminRoute>} />
        <Route
          path="/edit-support/:id" element={<AdminRoute>    <AddSupport />     </AdminRoute>} />
        <Route path="/add-orders" element={<AdminRoute>  <AddOrders /> </AdminRoute>} />
        <Route path="/order-details" element={<AdminRoute>  <OrderDetails />     </AdminRoute>} />
        <Route path="/manage-sub-orders" element={<AdminRoute> <ManageSubOrders />  </AdminRoute>} />
        <Route path="/add-sub-orders" element={<AdminRoute> <AddSubOrders /> </AdminRoute>} />
        <Route path="/edit-sub-order/:id" element={<AddSubOrders />} />
        <Route
          path="/manage-business-type" element={<AdminRoute>  <ManageBusinessType /> </AdminRoute>} />
        ...
        <Route path="/manage-products" element={<AdminRoute> <ManageProduct />   </AdminRoute>} />
        ...
        <Route path="/create-commission" element={<AdminRoute>    <CommissionPricing /></AdminRoute>} />
        ...
        <Notifications />
        <Route path="/view-notifications" element={<AdminRoute>   </AdminRoute>} />
