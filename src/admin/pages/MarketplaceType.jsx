        ...
        <div className="container-fluid px-4 pt-3">
          <div className="row mb-2">
            <div className="bg-white p-3 rounded shadow-sm card-header d-flex justify-content-between align-items-center">
              <h5 className="form-title m-0">Manage Marketplace Type</h5>
              <Link to="/add-market-type" className="btn btn-new-lead">
                <i className="bi bi-plus-circle me-1"></i> Add Marketplace Type
              </Link>
            </div>
          </div>
...
export default ManageMarketType;
