...
const ManageCommissionPricing = () => {
    ...
    const handleStatusChange = (e) => {
        setStatusFilter(e.target.value); // Keep as string: "", "1", or "0"
        setCurrentPage(1);
    };
    ...
    // Filter commissions on frontend (optional)
    const filteredCommissions = statusFilter
        ? commissions.filter((commission) => String(commission.status) === statusFilter)
        : commissions;
                            ...
                            <div className="row g-2 align-items-center">
                                ...
                                <div className="col-lg-6 text-end">
                                    <Link to="/create-commission" className="btn btn-new-lead">
                                        <i className="bi bi-plus-circle me-1"></i> Add Commission
                                    </Link>
                                </div>
                            </div>
                        </div>
