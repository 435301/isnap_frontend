...
import { createIssueType } from "../../redux/actions/issueTypeAction";
...
const AddIssueType = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await dispatch(createIssueType(formData));
      if (res?.status) {
        navigate("/manage-issue-type");
      }
    } catch (err) {
      console.log(err)
    }
            ...
            <div className="bg-white p-3 rounded shadow-sm card-header mb-2">
              <div className="row g-2 align-items-center">
                <div className="col-lg-6">
                  <h5 className="form-title m-0">Add Issue Type</h5>
                </div>
                <div className="col-lg-6 text-end">
                  <Link to="/manage-issue-type" className="btn btn-new-lead">
                    Manage Issue Type
                  </Link>
                </div>
              </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-12 d-flex justify-content-end mt-5 mb-4">
                    ...
                    <button
                      ...
                      onClick={() => navigate("/manage-issue-type")}
                    >
                      Cancel
                    </button>
                  </div>
